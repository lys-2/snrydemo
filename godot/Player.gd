...
var current_grenade = "Sticky Grenade"
...
func process_input(delta):
	...
	if is_on_floor():
		if Input.is_action_just_pressed("movement_jump"):
			vel.y = JUMP_SPEED
			create_sound('juimp', camera.global_transform.origin, -26)
	# ----------------------------------
...
func create_sound(sound_name, position=null, volume=0):
	...
	globals.play_sound(sound_name, false, position, volume)
