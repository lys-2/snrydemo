...
#Use this command : py "C:\Users\chime\Documents\Unreal Projects\snrydemo\blend\ExportedFbx\ImportAssetScript.py"
...
def ImportAllAssets():
	...
	def CreateTask_SM_Collection():
		################[ Import EmptyCollectionForUnrealExport_Temp as StaticMesh type ]################
		print('================[ New import task : EmptyCollectionForUnrealExport_Temp as StaticMesh type ]================')
		FilePath = os.path.join(r'C:\Users\chime\Documents\Unreal Projects\snrydemo\blend\ExportedFbx\StaticMesh\SM_Collection.fbx')
		AdditionalParameterLoc = os.path.join(r'C:\Users\chime\Documents\Unreal Projects\snrydemo\blend\ExportedFbx\StaticMesh\SM_EmptyCollectionForUnrealExport_Temp_AdditionalParameter.ini')
		...
		print('================[ import asset : EmptyCollectionForUnrealExport_Temp ]================')
		...
		if len(task.imported_object_paths) > 0:
			...
			asset = None
		if asset == None:
			ImportFailList.append('Asset "EmptyCollectionForUnrealExport_Temp" not found for after inport')
			return
		print('========================= Imports of EmptyCollectionForUnrealExport_Temp completed ! Post treatment started...	=========================')
		...
		print('========================= Post treatment of EmptyCollectionForUnrealExport_Temp completed !	 =========================')
